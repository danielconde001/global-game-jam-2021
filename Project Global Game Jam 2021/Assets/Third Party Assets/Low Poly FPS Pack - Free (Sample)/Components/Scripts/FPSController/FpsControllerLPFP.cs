...
#pragma warning restore 649
        ...
        {
            get { return input.RotateX * (handgunScriptLPFP.IsAiming ? aimMouseSensitivity : mouseSensitivity); }
        }
			
        /// Returns the target rotation of the camera around the x axis with no smoothing.
        private float RotationYRaw
        {
            get { return input.RotateY * (handgunScriptLPFP.IsAiming ? aimMouseSensitivity : mouseSensitivity); }
        }
        ...
        private void MoveCharacter()
        {
            ...
            if(rigidbodyVelocity.sqrMagnitude < 0.1f)
                isMoving = false;
            else
                isMoving = true;
        ...
        private void PlayFootstepSounds()
        {
            ...
            {
                _audioSource.clip = (canRun && input.Run) ? runningSound : walkingSound;
